        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-surface rounded-2xl p-8 border border-border shadow-sm">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-4 py-3 bg-background border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all"
                                    required
                                />
                            </div>
                        </div>
                    ...
                    {/* Social Login */}
                    <button className="w-full flex items-center justify-center gap-2 bg-background border border-border py-3 rounded-xl font-medium text-foreground hover:bg-border/50 transition-colors">
                ...
                <p className="text-center text-sm text-muted mt-6">
                    New to Forique?{" "}
                    <Link href="/onboarding" className="text-info hover:underline font-medium">
